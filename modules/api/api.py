...
class Api:
    def __init__(self, app: FastAPI, queue_lock: Lock):
        ...
        self.add_api_route("/sdapi/v1/txt2upscaledimgs", self.text2upscaledimgapi, methods=["POST"], response_model=models.TextToImageResponse) # Custom 
    ...
    def text2upscaledimgapi(self, txt2imgreq: models.StableDiffusionTxt2ImgProcessingAPI):
        script_runner = scripts.scripts_txt2img
        if not script_runner.scripts:
            script_runner.initialize_scripts(False)
            ui.create_ui()
        ...
        #upscaling
        listo = []
        for index, item in enumerate(b64images):
            info = {
                "data": item,
                "name": index
                }
